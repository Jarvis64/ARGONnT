...
'''
path_img       = '/home/frazer/Documents/LArnT/data'
path_data      = '/home/frazer/Documents/LArnT/img'
...
font_small = {'family': 'monospace',
        'color':  'black',
        'weight': 'normal',
        'size': 10,
        }

font_medium = {'family': 'monospace',
        'color':  'black',
        'weight': 'normal',
        'size': 12,
        }

font_large = {'family': 'monospace',
        'color':  'black',
        'weight': 'normal',
        'size': 16,
        }
